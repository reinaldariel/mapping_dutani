...
$str = "SELECT p.ID_User as ID_User, p.Nama_Petani, p.jml_lahan, 0 as jml_tercatat, 0 as bisa from master_petani p, trans_ang_petani t where p.ID_User NOT IN (SELECT DISTINCT ID_User from trans_lahan) and p.ID_User = t.ID_User";
$str2 = " UNION
SELECT tl.ID_User as ID_User, p.Nama_Petani, p.jml_lahan, COUNT(tl.ID_Lahan), (p.jml_lahan-COUNT(tl.ID_Lahan)) from trans_lahan tl, master_petani p, trans_ang_petani t WHERE tl.ID_User = p.ID_User and p.ID_User = t.ID_User";
