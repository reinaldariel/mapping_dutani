...
$str = "SELECT DISTINCT d.id_lahan as ID_Lahan, p.Nama_Petani as nama,l.Desa as desa,tl.ID_User as id_user, k.Nama_Kelompok_Tani, k.col_hex, l.Koordinat_X as lat,l.Koordinat_Y as longt 
