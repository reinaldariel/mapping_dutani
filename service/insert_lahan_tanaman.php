...
try {
    $sql = "INSERT INTO `master_peta_lahan_tanaman` (`id_detail_tanaman`,`ID_Lahan`, `ID_Spesies`, `kebutuhan_benih`, `kebutuhan_saprotan`, `bulan_tanam`, `bulan_akhir`, `rata_hasil_panen`) VALUES (NULL, '".$id_lahan."', '".$ID_Spesies."', ".$kebutuhan_benih.", ".$kebutuhan_saprotan.", '".$bulan_tanam."', '".$bulan_panen."', ".$rata_hasil_panen.");";
