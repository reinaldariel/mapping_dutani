        ...
        <div class="mother-grid-inner">
            ...
            <div class="grid-form">
                <div class="grid-form1" style="padding-bottom: 5px; padding-top: 5px;margin-bottom: 0;">
                    <a href="<?php echo $BASE_URL."detail_titik_lahan.php?id_lahan=".$_GET['id_lahan']."&idp=".$_GET['idp']; ?>" style="color:#191919;"><i class="fa fa-caret-square-o-left" aria-hidden="true"></i> Detail Titik Lahan</a>
                </div>
